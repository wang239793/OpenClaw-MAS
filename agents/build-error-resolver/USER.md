...
## Use this file for
- Project-specific build toolchain (webpack, vite, tsc version, etc.)
- Known recurring build issues and their confirmed fixes
- Custom tsconfig paths or module aliases that affect error diagnosis
